...
import com.sternitc.kafka.kafkastreams.pricethresholdapplication.adapter.out.messaging.ArticlePriceThresholdMessagingConfiguration;
...
public class ConsumerCreatorConfiguration {
    ...
    @KafkaListener(
            topics = ArticlePriceThresholdMessagingConfiguration.priceBoundaryTopic,
            groupId = "group_id")
    public void listenToArticlePriceThresholdMessages(Map<String,Object> message) {
